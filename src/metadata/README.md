 ...
 * [automatce.yml](automatce.yml)
     * Determines how your purl.obolibrary.org/obo/automatce/ redirects will be handled
     ...
     * Paste in the contents of [automatce.yml](automatce.yml)
 ...
 * [automatce.md](automatce.md)
     ...
     * Paste in the contents of [automatce.md](automatce.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
